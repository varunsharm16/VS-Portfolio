...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      {/* Background Video - Hidden on mobile due to transparency issues */}
      <div className="absolute inset-0 z-0 hidden md:flex items-end justify-end pointer-events-none">
