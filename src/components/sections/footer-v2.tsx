...
const FooterView = () => {
  const currentYear = new Date().getFullYear();
    ...
    { label: "GitHub", href: "https://github.com/varunsharm16" },
    // { label: "Twitter", href: "https://twitter.com" },
    { label: "Email", href: "mailto:vsharm21@student.ubc.ca" }]
        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_2.2fr_2.4fr] border border-white/10 rounded-[1.25rem] overflow-hidden font-mono text-white">
          ...
          <div className="flex flex-col p-8 md:p-10 border-b md:border-b-0 md:border-r border-white/10 bg-[#333333]">
            ...
            <div className="flex flex-col space-y-3">
              <span className="text-[12px] text-white/80 tracking-[0.05em] leading-normal !whitespace-pre-line">Vancouver / Calgary

              </span>
              <span className="text-[12px] text-white/80 tracking-[0.05em] leading-normal !whitespace-pre-line !whitespace-pre-line">Timezone: PST / MST
          ...
          <div className="flex flex-col p-8 md:p-10 bg-[#333333]">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <span className="text-[12px] text-white/80 tracking-[0.05em] leading-normal !whitespace-pre-line">Available from January 2026
