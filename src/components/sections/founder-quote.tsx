            ...
            <div className="lg:col-span-5 flex flex-col items-center">
              <div className="flex flex-col items-center w-full max-w-[480px]">
                <div className="relative w-full aspect-[0.82] bg-white">
                    <Image
                      src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/Gemini_Generated_Image_iobsxfiobsxfiobs-1766300906547.jpg?width=8000&height=8000&resize=contain"
                      ...
                      priority 
                      style={{ 
                        WebkitMaskImage: 'linear-gradient(to bottom, black 40%, transparent 92%), linear-gradient(to right, transparent, black 15%, black 85%, transparent)',
                        maskImage: 'linear-gradient(to bottom, black 40%, transparent 92%), linear-gradient(to right, transparent, black 15%, black 85%, transparent)',
